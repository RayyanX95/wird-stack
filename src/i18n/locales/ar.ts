...
export default {
  ...
  privacy: {
    ...
    summaryBody:
      'لا حسابات في WirdStack، ولا تحليلات، ولا ملفات ارتباط، ولا إعلانات. أورادك وسجلّها تُكتب في متصفحك أنت ولا تُرسَل إلى أي مكان. الشيء الوحيد الذي يغادر جهازك هو موقع تقريبي، يُستخدم لحساب أوقات صلاتك.',
    ...
    neverBody:
      'لا حسابات. ولا تتبّع ولا تحليلات من أي نوع. ولا ملفات ارتباط. ولا إعلانات. لا شيء يُباع أو يُشارَك، لأنه لا شيء يُجمع من الأساس.',
