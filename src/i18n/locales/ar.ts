...
export default {
  ...
  privacy: {
    ...
    analyticsBody:
      'نحصي مشاهدات الصفحات عبر Vercel Web Analytics، لنعرف إن كان التطبيق يُستخدم أصلًا. لا يضع ملفات ارتباط، ولا يتبعك إلى أي موقع آخر، ولا يسجّل شيئًا عن أورادك — فقط أن صفحة فُتحت، ومن أي بلد تقريبًا، وعلى أي نوع من الأجهزة. والأرقام إجمالية: لا يوجد ملف شخصي لأحد يمكن الاطلاع عليه، ولا حتى لنا.',
