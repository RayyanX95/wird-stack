...
export default {
  ...
  privacy: {
    ...
    summaryBody:
      'لا حسابات في WirdStack، ولا ملفات ارتباط، ولا إعلانات. أورادك وسجلّها تُكتب في متصفحك أنت ولا تُرسَل إلى أي مكان. شيئان يغادران جهازك: موقع تقريبي يُستخدم لحساب أوقات صلاتك، وعدد مجهول المصدر للصفحات التي فُتحت.',
    ...
    sentBody:
      'موقعك التقريبي، ولا شيء غيره. يذهب إلى خدمتين تحوّلانه إلى أوقات صلاة واسم مدينة. نحن لا نتحكم بهما، وتسري سياسات الخصوصية الخاصة بهما:',
    sentAladhanName: 'Aladhan (aladhan.com)',
    sentAladhanDetail:
      'تتلقى إحداثياتك التقريبية وطريقة الحساب، وتعيد أوقات الصلاة. أورادك لا تُرسَل إليها أبدًا.',
    sentGeocodeName: 'BigDataCloud (bigdatacloud.com)',
    sentGeocodeDetail:
      'تتلقى الإحداثيات التقريبية نفسها مرة واحدة لكل موقع، وتعيد اسم المدينة ليقول التطبيق «الرياض» بدلًا من رقمين.',

    infraHeading: 'من يرى عنوان IP الخاص بك',
    infraBody:
      'تحميل أي موقع يكشف عنوان IP الخاص بك لمن يقدّمه — هكذا تعمل الويب، وليس خيارًا يتخذه هذا التطبيق. جهتان تشاركان في تقديم WirdStack، ولا تتلقى أي منهما أورادك ولا موقعك:',
    ...
    precisionBody:
      'لا يطلب التطبيق موقعك من المتصفح إلا بإذنك، ولك أن ترفض — عندها يعود إلى توقيت مكة المكرمة ويصرّح بذلك. وقبل إرسال أي إحداثيات تُقرَّب إلى منزلتين عشريتين، أي ما يقارب كيلومترًا واحدًا. وهذا أدق مما تحتاجه أوقات الصلاة، التي تتغير بنحو دقيقة كل 20 كم، ويعني أن التحديد الدقيق الذي أنتجه جهازك لا يغادره أبدًا.',

    analyticsHeading: 'الإحصاءات',
    analyticsBody:
      'نحصي مشاهدات الصفحات عبر Cloudflare Web Analytics، لنعرف إن كان التطبيق يُستخدم أصلًا. لا يضع ملفات ارتباط، ولا يتبعك إلى أي موقع آخر، ولا يسجّل شيئًا عن أورادك — فقط أن صفحة فُتحت، ومن أي بلد تقريبًا، وعلى أي نوع من الأجهزة. والأرقام إجمالية: لا يوجد ملف شخصي لأحد يمكن الاطلاع عليه، ولا حتى لنا.',

    neverHeading: 'ما لا نفعله أبدًا',
    neverBody:
      'لا حسابات. ولا ملفات ارتباط. ولا إعلانات. لا يُبنى عنك ملف شخصي، ولا يُباع شيء أو يُشارَك أبدًا. وأورادك ليست جزءًا من إحصاء المشاهدات أعلاه ولا تغادر جهازك.',

    controlHeading: 'تحكّمك',
    controlBody:
      'يمكنك سحب إذن الموقع متى شئت من إعدادات متصفحك. ومسح بيانات الموقع الخاصة بـ WirdStack من متصفحك يمحو كل ما خزّنه التطبيق فورًا ونهائيًا — لذا صدّر نسخة احتياطية أولًا إن أردت الاحتفاظ بسجلّك. ولأنه لا توجد حسابات، لا توجد بيانات لك محفوظة لدينا لنحذفها عند الطلب.',
